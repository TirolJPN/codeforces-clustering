...
def main():
    ...
    sql = "SELECT problem_id , count(*) as cnt FROM File WHERE problem_id IS NOT NUll AND verdict = \"OK\" AND (lang = \"GNU C++14\" OR lang = \"GNU C++11\" OR lang = \"GNU C++\") GROUP BY problem_id HAVING count(*) > 100 "
